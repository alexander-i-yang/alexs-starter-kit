...
public class ContourTracer
{
    ...
    public void Trace(Texture2D texture, Vector2 pivot, float pixelsPerUnit, uint gapLength, float product, float alphaCutoff = 0)
    {
        pathCount = 0;
        ...
        bool IsBorder(int _x, int _y)
        {
            ...
            return pixels[pixelIndex].a > alphaCutoff;
        }
